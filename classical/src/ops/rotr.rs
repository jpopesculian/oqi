...
impl Value {
    pub fn rotr_(self, rhs: Self) -> Result<Self> {
        Rotr::checked_op(self, rhs)
    }
}
...
mod tests {
    ...
    #[test]
    fn rotr_bitreg_by_1() {
        // 0b0001 in 4 bits rotated right by 1 = 0b1000
    ...
    #[test]
    fn rotr_uint_by_2() {
        // 0b0000_0011 rotated right 2 in 8 bits = 0b1100_0000
        let r = u_scalar(0b0000_0011, 8).rotr_(i_scalar(2, 8)).unwrap();
        match r {
            Value::Scalar(s) => {
    ...
    #[test]
    fn rotr_negative_equals_rotl() {
        // rotr(a, -3) == rotl(a, 3)
        let a = bitreg(0b0010_1010, 8);
