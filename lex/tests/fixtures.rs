...
fn antlr_type_name<'a>(token: &Token<'a>) -> &'static str {
    match token {
        ...
        Token::DoubleEquals => "EqualityOperator",
        Token::ExclamationEquals => "EqualityOperator",
        Token::PlusEquals => "CompoundAssignmentOperator",
        Token::MinusEquals => "CompoundAssignmentOperator",
        Token::AsteriskEquals => "CompoundAssignmentOperator",
        Token::SlashEquals => "CompoundAssignmentOperator",
        Token::AmpersandEquals => "CompoundAssignmentOperator",
        Token::PipeEquals => "CompoundAssignmentOperator",
        Token::CaretEquals => "CompoundAssignmentOperator",
        Token::LeftShiftEquals => "CompoundAssignmentOperator",
        Token::RightShiftEquals => "CompoundAssignmentOperator",
        Token::PercentEquals => "CompoundAssignmentOperator",
        Token::DoubleAsteriskEquals => "CompoundAssignmentOperator",
        Token::GreaterThan => "ComparisonOperator",
        Token::LessThan => "ComparisonOperator",
        Token::GreaterThanEquals => "ComparisonOperator",
        Token::LessThanEquals => "ComparisonOperator",
        Token::DoubleGreater => "BitshiftOperator",
        Token::DoubleLess => "BitshiftOperator",
